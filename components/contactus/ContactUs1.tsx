...
const ContactUs1 = () => {
    return (
        <div className="relative overflow-hidden">
            ...
            />
            <div className="bg-[#086718] bg-opacity-80 h-[720px] sm:h-[800px] md:h-[900px] lg:h-[70vh] xl:h-[80vh] 2xl:h-[80vh] 3xl:h-[65vh] top-0 absolute w-full backdrop-blur-sm z-10">
                <div className="max-w-sm sm:max-w-lg md:max-w-2xl lg:max-w-5xl xl:max-w-7xl mx-auto mt-8 md:mt-5 lg:mt-20 xl:mt-10 2xl:mt-24 px-4 space-y-8 ">
                    <H1
                        ...
                        viewport={{ once: true }}
                        className="text-[#51D055] sm:tracking-tight md:tracking-normal text-4xl sm:text-6xl font-semibold max-w-xl leading-tight"
                    >
                    ...
                    <div className="lg:pt-10 grid grid-cols-1 lg:grid-cols-3 gap-8 items-center pt-6">
                        {
                            contactUsdata.map((item, index) => (
                                <Div
                                    ...
                                    viewport={{ once: true }}
                                    key={index}
                                    className="border-white border rounded-md md:p-10 p-4 sm:p-6 lg:p-6 xl:p-8 flex items-start gap-5 bg-[#086718] bg-opacity-70 z-20 bg-blend-luminosity shadow-[inset_0_0_10px_rgba(255,255,255,0.3)]"
                                >
                                    ...
                                    <div className="flex flex-col md:gap-6 lg:gap-4 xl:gap-6">
                                        <h2 className="font-semibold text-xl sm:text-2xl lg:text-xl text-[#51D055]">{item.title}</h2>
