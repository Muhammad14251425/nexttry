...
import greenMainPic from '@/public/aboutus/aboutUsmain.jpeg'
        ...
        <div className='relative'>
            ...
            <div className='absolute top-0 max-w-7xl mx-auto w-screen inset-0 h-full flex items-center px-4'>
                <div className='h-[450px] w-[580px] bg-white rounded-3xl p-16 space-y-3'>
                    <h3 className='font-semibold text-[#51D055]'>Fast, Reliable, Efficient</h3>
                    ...
                    <div className='pt-6 flex gap-5'>
                        <button className='bg-[#51D055] h-12 w-36 rounded-md text-white '>Learn More</button>
                        <button className='flex items-center gap-2 group hover:bg-[#51D055] hover:bg-opacity-40 transition-colors duration-700 px-4 py-2 rounded-md'>
                            Our Services
