            ...
            <Div className='max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-7xl mx-auto relative lg:pb-6'>
                ...
                <div className='absolute top-2 grid grid-cols-1 lg:grid-cols-2 px-4 sm:px-0'>
                    <div className='lg:p-6 lg:px-8 xl:px-14'>
                        <div className='flex flex-col 480:flex-row items-start 480:items-center gap-8 480:gap-3 480:mt-12'>
                            <button className='text-xs sm:text-sm px-4 py-2 lg:text-xs font-semibold text-[#ED3224] border rounded-full border-[#ED3224]' >What{"'"}s New</button>
                            <h2 className='flex items-center gap-1 text-[#ED3224] text-xs sm:text-sm lg:text-xs font-semibold tracking-wide'>Introducing our new fleet of eco-friendly trucks
                        ...
                        <div className='flex items-center gap-3 480:gap-10 mb-16'>
                            <button className='bg-[#ED3224] text-white px-2 py-3 sm:px-8 sm:py-3 lg:py-5 font-semibold rounded-md text-sm sm:text-base'>Explore Our Services</button>
                            <button className='border px-3 py-3 rounded-md border-black 480:border-none flex items-center gap-2 group text-sm sm:text-base'>Learn More <Image src={arrow} alt='greater than' className='h-3 w-3 group-hover:translate-x-3 transform duration-300' /> </button>
                        </div>
                    </div>
