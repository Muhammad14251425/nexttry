    ...
    return (
        <div className='h-[96vh] w-screen relative'>
            ...
            <Div className='absolute top-0 flex flex-col items-center justify-center gap-8 h-[96vh] w-screen'>
                ...
                <Buttton
                    className='group bg-black flex items-center gap-4 font-semibold text-xl text-white px-8 py-3 rounded-md'
                    initial={{ y: 90, opacity: 0 }}
                    whileInView={{ y: 0, opacity: 1 }}
                    transition={{ duration: 0.5 }}
                    viewport={{ once: true }}
